...
func (s TokenModel) New(userID int64, ttl time.Duration, scope string) (*Token, error) {
...
func (s TokenModel) Insert(token *Token) error {
	query := `
...
func (s TokenModel) DeleteAllForUser(scope string, userID int64) error {
	query := `
		DELETE FROM tokens
